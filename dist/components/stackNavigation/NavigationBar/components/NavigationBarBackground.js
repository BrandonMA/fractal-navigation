...
export var NavigationBarBackground = memo(function (_a) {
    ...
    return (React.createElement(BaseBox, { backgroundColor: 'navigationBarBackground', flexDirection: 'row', height: navigationBar.navigationBarHeight, shadowOffset: shadowProperties.offset, shadowColor: 'shadowColor', shadowOpacity: shadowProperties.opacity, shadowRadius: shadowProperties.radius, width: '100%', zIndex: 2000, paddingHorizontal: 'm', elevation: 1 }, children));
});
